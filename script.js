...
const data = [
    { name: "Kumar", age: 24, profession: "developer" },
    { name: "Srinu", age: 27, profession: "admin" },
];
...
function concatenateArray() {
    const example = [
         { name: "Tarun", age: 24, profession: "developer" },
         { name: "Abhi", age: 27, profession: "admin" },
         { name: "Vamsi", age: 23, profession: "developer" },
         { name: "Sai", age: 28, profession: "admin" }];
